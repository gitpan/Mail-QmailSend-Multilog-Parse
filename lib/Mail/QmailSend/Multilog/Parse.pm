package Mail::QmailSend::Multilog::Parse;
...
Mail::QmailSend::Multilog::Parse - Parse qmail-send multilog files
...
=head1 SYNOPSIS
  ...
  my $parser = Mail::QmailSend::Multilog::Parse->new(callback => sub { print YAML::Dump(@_)});
  $parser->parse(\*STDIN);
